...
// Enhanced AI Provider implementations with resilience
...
const handler: Handler = async (event: HandlerEvent) => {
  ...
  await monitoring.recordSystemMetric('webhook.requests.total', 1, 'counter');
  ...
  try {
    ...
    await monitoring.recordSystemMetric('webhook.processing_time', processingTime, 'histogram');
